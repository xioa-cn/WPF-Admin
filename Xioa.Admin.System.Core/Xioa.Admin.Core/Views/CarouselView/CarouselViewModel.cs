...
public partial class CarouselViewModel : ViewModelBase
{
    ...
    private void LoadSampleImages()
    {
        try
        {
            ...
            {
                ImageSource = "/Xioa.Admin.Core;component/Assets/Img/Carousel/sample1.jpg",
                IsActive = true
            };
            var image2 = new CarouselImage
            {
                ImageSource = "/Xioa.Admin.Core;component/Assets/Img/Carousel/sample2.jpg"
            };
            var image3 = new CarouselImage
            {
                ImageSource = "/Xioa.Admin.Core;component/Assets/Img/Carousel/sample3.jpg"
            };
